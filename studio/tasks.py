...
def apply_voiceover_and_send(asset_id, video_url):
    ...
    try:
        ...
        # Generate Audio
        generate_voiceover(asset.narration_text, audio)
...
def process_telegram_intent(chat_id, account_id, user_input, file_id=None, media_type=None):
    ...
    # Parse Intent
    parsed_intent = parse_influencer_intent(user_input, has_photo, has_video)
    ...
    if intent == 'ADD_INFLUENCER':
        ...
        try:
            ...
            images = create_scene_with_character([local_path], enhanced_prompt)
            if images:
